...
export default function Sidebar({ onOpenSettings }) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-[230px] flex-col border-r border-border bg-panel">
      <div className="border-b border-border px-5 py-5">
        <h1 className="text-[17px] font-semibold leading-none">Catalog Admin</h1>
        <div className="mt-1.5 truncate text-[12px] text-muted" title={user?.email}>
